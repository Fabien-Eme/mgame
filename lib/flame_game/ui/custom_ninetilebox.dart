...
class CustomNineTileBox {
  ...
  CustomNineTileBox(this.sprite, {int? tileSize, int? destTileSize, this.opacity = 1.0}) : tileSize = tileSize ?? sprite.src.width ~/ 3 {
  ...
  void drawRect(Canvas c, [Rect? dst]) {
    c.drawImageNine(
      ...
      center,
      dst ?? _dst,
      _whitePaint..color = _whitePaint.color.withOpacity(opacity),
    );
  }
